                    ...
                    <div class="table-responsive mt-4">
                        @auth
                            ...
                            <div class="mt-4">
                                ...
                                <h5 class="font-size-16">
                                    {{ $viewData->no_hp ?? 'Default No Hp' }}
                                </h5>
                            </div>
                            <div class="mt-4">
                                <p class="mb-1">E-mail :</p>
                                <h5 class="font-size-16">{{ $viewData->email ?? 'Default E-mail' }}</h5>
                            </div>
                        ...
                        <div class="tab-content">
                            <div id="about-me" class="tab-pane fade active show">
                                <div class="profile-personal-info">
                                        <br>
                                            @if ($viewData !== null && ($viewData->no_hp == null || $viewData->tempat_lahir == null || $viewData->gender == null || $viewData->alamat == null))
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-sm-9 col-7">{{ $viewData->nama ?? 'Default Name' }}</div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col-sm-3 col-5">
                                                ...
                                                <div class="col-sm-9 col-7">
                                                    {{ $viewData->gender ?? 'Deafult gender' }}
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col-sm-3 col-5">
                                                ...
                                                <div class="col-sm-9 col-7">
                                                    {{ $viewData->tempat_lahir ?? 'Default Tempat Lahir' }}
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col-sm-3 col-5">
                                                ...
                                                <div class="col-sm-9 col-7">
                                                    {{ $viewData->tanggal_lahir ?? 'Default Tempat Lahir' }}
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col-sm-3 col-5">
                                                ...
                                                <div class="col-sm-9 col-7">
                                                    {{ $viewData->alamat ?? 'Default Alamat' }}
                                                </div>
                                            </div>
                                </div>
                                ...
                                <div class="profile-about-me">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-sm-3 col-5">
                                            <h5 class="f-w-500"><i class="fas fa-instagram"></i>
                                                {{ $viewData->instagram ?? 'Default Instagram' }}
                                            </h5>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <form action="{{route('update-user', $viewData->user_id)}}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="email" value="{{ $viewData->email ?? 'Default Email' }}"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="mb-3 col-md-6">
                                                            ...
                                                            <img class="avatar-lg rounded-circle img-thumbnail"
                                                                src="{{ url('/' . ($viewData->foto ?? 'default-image.jpg')) }}" width="75px" height="auto" alt="">
                                                            @error('foto')
                                                    ...
                                                    <div class="row">
                                                        <div class="mb-3 col-md-6">
                                                            ...
                                                            <input type="text" value="{{ $viewData->tempat_lahir ?? old('tempat') }}" class="form-control" name="tempat">
                                                            @error('tempat')
                                                                <div class="alert alert-warning" role="alert">
                                                                    <strong>Warning!</strong>
                                                                    {{ $message }}
                                                        ...
                                                        <div class="mb-3 col-md-6">
                                                            ...
                                                            <input type="date" value="{{ $viewData->tanggal_lahir ?? old('tanggal') }}" 
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="alamat" id="" cols="30" rows="5"
                                                            class="form-control">{{$viewData->tanggal_lahir ?? old('tanggal') }}</textarea>
                                                    </div>

                                                    <div class="row">
                                                        <div class="mb-3 col-md-6">
                                                            <label class="form-label">No HP</label>
                                                            <input type="text" value="{{ $viewData->no_hp ?? old('hp') }}"
                                                        ...
                                                        <div class="mb-3 col-md-6">
                                                            <label class="form-label">Sosial Media
                                                                Instagram</label>
                                                            <input type="text" value="{{ $viewData->instagram ?? old('ig') }}" 
