...
<body>
    <div class="container">
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                ...
                <img src="{{ asset('sipenmaru/images/logosmakda.png') }}" class="image" style="float: right; margin-left: 470px; width: 350px; height: auto;" alt="" />
    ...
    <!--'/sipenmaru/js/styleSwitcher.js') }}"></script>-->
