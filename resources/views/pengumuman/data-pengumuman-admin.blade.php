                                ...
                                <table id="example3" class="display" style="min-width: 845px">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($viewData as $x)
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <a class="btn btn-secondary shadow btn-xs sharp me-1"
                                                            ...
                                                            @if ($x->pendaftaran) href="view-announcement/{{ $x->pendaftaran->id_pendaftaran }}"><i class="fa fa-file"></i> <!-- Replace with your actual icon -->
                                                            @else
                                                                No announcement found @endif
                                                            </a>
                                                            ...
                                                            <div class="modal fade delete{{ $x->id_pengumuman }}"
                                                                ...
                                                                <div class="modal-dialog modal-sm">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body text-center"><i
                                                                                class="fa fa-trash"></i><br> Apakah anda yakin
                                                                            ingn menghapus data ini?
                                                                            <br>{{ $x->id_pengumuman }}
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <form
                                                                                action="delete-announcement/{{ $x->id_pengumuman }}"
                                                                                method="POST">
                                                                                @csrf
                                                                                @method('DELETE')
                                                                                <button type="submit"
                                                                                    class="btn btn-danger">Ya, Hapus Data
                                                                                    Ini</button>
                                                                            </form>
                                                                        </div>
                                                                    </div>
                                            ...
                                            <div class="modal fade edit{{ $x->id_pengumuman }}" tabindex="-1"
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="/update-announcement/{{ $x->id_pengumuman }}"
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="row">
                                                                        <div class="col-xl-6">
                                                                            ...
                                                                            <select class="default-select form-control wide"
                                                                                ...
                                                                                <option value="{{ $x->id_pendaftaran }}">
                                                                                    {{ $x->pendaftaran ? $x->pendaftaran->id_pendaftaran : 'N/A' }}
                                                                                </option>
                                                                            </select>
                                                                        ...
                                                                        <div class="col-xl-6">
                                                                            ...
                                                                            <select class="default-select form-control wide"
                                                                                title="Result" name="hasil">
                                                                                <option value="{{ $x->hasil_seleksi }}"
                                                                                    selected>{{ $x->hasil_seleksi }}</option>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="default-select form-control wide"
                                                                        title="Recipient" name="jurusan">
                                                                        @if ($x->hasil_seleksi == 'LULUS' || $x->hasil_seleksi == 'Lulus' || $x->hasil_seleksi == 'lulus')
                                                                            <option value="{{ $x->jurusan_penerima ?? '' }}"
                                                                                selected>
                                                                                {{ $x->jurusan->nama_jurusan ?? 'No Jurusan Available' }}
                                                                            </option>
                                                                        @endif
                                                                        <option value="{{ $x->pendaftaran->pil1 }}">Pilihan 1
                                                                            : {{ $x->pendaftaran->pilihan1->nama_prodi }}
                                                                        </option>
                                                                        <option value="{{ $x->pendaftaran->pil2 }}">Pilihan 2
                                                                            : {{ $x->pendaftaran->pilihan2->nama_prodi }}
                                                                        </option>
