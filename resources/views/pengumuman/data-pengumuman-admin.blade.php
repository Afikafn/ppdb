                                    ...
                                    @foreach ($viewData as $x)
                                        <tr>
                                            ...
                                            <td>@if ($x->hasil_seleksi == "LULUS" || $x->hasil_seleksi == "Lulus" || $x->hasil_seleksi == "lulus") 
                                                ...
                                                @else
                                                    <p>No jurusan available</p> <!-- Optional: Handle the null case -->
                                                @endif
                                            @endif
                                            </td>
                                            <td>
                                                <div class="d-flex">
                                                    <a class="btn btn-secondary shadow btn-xs sharp me-1"
                                                            ...
                                                            @if($x->pendaftaran)
                                                                href="view-announcement/{{ $x->pendaftaran->id_pendaftaran }}"><i class="fa fa-file"></i> <!-- Replace with your actual icon -->
                                                            @else
                                                        ...
                                                        <div class="modal-dialog modal-sm">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form action="delete-announcement/{{ $x->id_pengumuman }}" method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="update-announcement/{{ $x->id_pengumuman }}"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xl-6">
                                                                        ...
                                                                        <select class="default-select form-control wide"
                                                                            ...
                                                                            required>
                                                                            <option value="{{ $x->id_pendaftaran }}">{{ $x->pendaftaran ? $x->pendaftaran->id_pendaftaran : 'N/A' }}</option>
                                                                        </select>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="iduser">Jurusan Penerima </label>
                                                                <select class="default-select form-control wide" title="Recipient" name="jurusan" required>
                                                                    @if ($x->hasil_seleksi == "LULUS" || $x->hasil_seleksi == "Lulus" || $x->hasil_seleksi == "lulus") 
                                                                        @if ($x->jurusan)
                                                                            <option value="{{ $x->jurusan_penerima }}" selected>{{ $x->jurusan->nama_jurusan }}</option>
                                                                        @else
                                                                            <option value="" disabled>No Jurusan Available</option>
                                                                        @endif
                                                                    @endif
                                                                    @if ($x->pendaftaran)
                                                                        @if ($x->pendaftaran->pilihan1)
                                                                            <option value="{{ $x->pendaftaran->pil1 }}">{{ $x->pendaftaran->pilihan1->nama_jurusan }}</option>
                                                                        @else
                                                                            <option value="" disabled>Pilihan 1: No Jurusan Available</option>
                                                                        @endif
                                                                        @if ($x->pendaftaran->pilihan2)
                                                                            <option value="{{ $x->pendaftaran->pil2 }}">{{ $x->pendaftaran->pilihan2->nama_jurusan }}</option>
                                                                        @else
                                                                            <option value="" disabled>Pilihan 2: No Jurusan Available</option>
                                                                        @endif
                                                                    @endif
