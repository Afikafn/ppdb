        ...
        ***********************************-->
        <div class="nav-header">
            <a href="dashboard" class="brand-logo">
                <img alt="image" width="25" src="{{ asset('sipenmaru/images/logosmakda.png') }}">
                <div class="brand-title">
                    <h3 class="">PPDB SMAKDA</h3>
                </div>
            </a>
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0);" role="button"
                                    ...
                                    @if (isset(auth()->user()->profile) && auth()->user()->profile->foto != null)
                                        <img class="avatar-lg rounded-circle img-thumbnail" src="{{ url('/' . auth()->user()->profile->foto) }}" alt="" width="75px" />
                                    @else
        ...
        ***********************************-->
        ...
        <div class="dlabnav">
            ...
            <div class="dlabnav-scroll">
                ...
                <div class="copyright">
                    <p><strong>SIPPDB SMAKDA </strong> ©
                        <script>
                            document.write(new Date().getFullYear())
                        </script> All Rights Reserved</p>
                    <p class="fs-12">Made with <span class="heart"></span> by Afika F. Nursafitri</p>
                </div>
            </div>
        </div>
        <!--**********************************
        ...
        <div class="footer">
            <div class="copyright">
                <p>Copyright ©
                    ...
                    Designed &amp; Developed by <a href="https://www.instagram.com/piaaasan/" target="_blank">Afika F. Nursafitri</a>
                </p>
            </div>
        </div>
        <!--**********************************
